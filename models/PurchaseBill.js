...
purchaseBillSchema.virtual('calculatedBalance').get(function() {
  return this.paymentType === 'advance' ? this.grandTotal - this.advance : 0;
});


// Indexes for better query performance
purchaseBillSchema.index({ bill_number: 1, org: 1 }, { unique: true });
purchaseBillSchema.index({ bill_to: 1 });
purchaseBillSchema.index({ org: 1 });
